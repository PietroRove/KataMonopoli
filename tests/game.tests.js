...
/*it("Create a game with two players named Horse and Car. Within creating 100 games, both orders [Horse, Car] and [car, horse] occur.", function() {
    ...
    var conteggioOccorrenzeHC=0;
    var conteggioOccorrenzeCH = 0;
    var tot = 2;
    ...
    for(var i=0;i<tot;i++)
    {
        ...
        this.game.createNewGame(listPlayer,0);
    ...
    if( (conteggioOccorrenzeHC+conteggioOccorrenzeCH) == tot)
        return true;
    return false;
});*/
